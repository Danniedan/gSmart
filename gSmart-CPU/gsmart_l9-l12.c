...
int main(int argc, char** argv)
{
  ...
  int M;
	...
	char * filename1="./data/wat100r_l9.txt";
	char * filename2="./data/wat100c_l9.txt";
  ...
  for (i=0; i<nnz; i++)
  {
	...
	//constants 23658, 14401, 21076
	int con[num_con] = {111017};
